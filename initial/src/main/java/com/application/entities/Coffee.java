...
public class Coffee {
    ...
    public Date getRoastDate() { return roastDate; }
    public void setRoastDate(Date roastDate) { this.roastDate = roastDate; }
    public String getBrand() { return brand; }
    public void setBrand(String brand) { this.brand = brand; }
    public String getSecondaryFlavours() { return secondaryFlavours; }
    public void setSecondaryFlavours(String secondaryFlavours) { this.secondaryFlavours = secondaryFlavours; }
    ...
    public RoastColor getColor() { return color; }
    public void setColor(RoastColor color) { this.color = color; }
